...
1. **Mesh-local CA and domain-free HTTPS — Partial.**
   ...
   to a complete Stage 10 acceptance record.

2. **Automatic ACME and DNS challenge handling — Partial.**
...
3. **Encrypted certificate delivery and rotation — Partial.**
...
4. **External automated certificate publisher — Partial.**
...
5. **Live ACME acceptance — Open; external prerequisites required.**
...
6. **Automatic backup scheduling, local/remote-node copies and retention — Recorded complete.**
...
7. **Backup providers, federation destinations and failure overlap — Partial.**
...
8. **Backup history, encrypted export and restore-readiness API/panel — Recorded complete.**
...
9. **Interrupted backup publication and abandoned-object retirement — Partial.**
...
10. **Offline verification and disaster recovery — Partial.**
...
11. **Self-contained embedded web panels — Recorded complete.**
...
12. **Plain-language operational dashboard and administration — Partial.**
...
13. **Complete redacted diagnostic bundle — Partial.**
...
14. **Bounded metrics foundation and authenticated exporter — Recorded complete.**
...
15. **Protection and locality measurements — Open.**
...
16. **Capacity, target IO and background-work measurements — Partial.**
...
17. **Gateway and data-path measurements — Partial.**
...
18. **Consensus and federation measurements — Open.**
...
19. **Security, operational lifecycle, resource and clock measurements — Open.**
...
20. **Bounded local metric history — Open.**
...
22. **Mesh-wide rolling updates — Open.**
...
23. **Migration and supported recovery acceptance — Open.**
...
24. **Native and container packaging — Open.**
...
25. **Local signed release/update tooling — Open; publication held.**
...
26. **Dependency/toolchain admission — Recorded complete.**
...
27. **Packaged-platform HTTPS/SMB acceptance — Open.**
...
1. **Topology and scale matrix — Open.**
...
2. **Two simultaneous machine failures — Open; hardware required.**
...
3. **Corruption, storage exhaustion and interrupted IO — Open.**
...
4. **Physical churn and multi-way partitions — Open; hardware required in part.**
...
5. **One-hour Home/Office isolation — Open.**
...
6. **Campus/building isolation — Open.**
...
7. **Strong acknowledgement zones — Open.**
...
8. **Full real-client appliance workflows — Open.**
...
9. **Federation and delegated authority — Open.**
...
10. **Candidate backup, restore, upgrade and recovery — Open.**
...
11. **Candidate certificate lifecycle — Open.**
...
12. **Performance and heterogeneous-drive acceptance — Open.**
...
13. **Seven-day active candidate soak — Open; elapsed time/hardware required.**
...
14. **Independent security review and unresolved reliability findings — Open.**
...
15. **Final requirement reconciliation and publication decision — Open; publication held.**
...
1. **Capacity-normalised group measurements — Open.**
...
2. **Automatic group creation and direct delegation — Open.**
...
3. **Online split, merge and rebalance — Open.**
...
4. **Automatic voter placement and stable decisions — Open.**
...
5. **Interrupted-transition and performance proof — Open.**
