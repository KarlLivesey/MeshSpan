...
21. **Durable notifications — Partial; outbox implemented.** **8 points remaining.**
    ...
    Scheduling, transports, API/panel and daemon delivery remain; the estimate
    stays unchanged until the complete delivery path runs.
