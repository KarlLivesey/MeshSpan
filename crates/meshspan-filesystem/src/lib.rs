...
pub use publication::{
    ...
    NamespaceHistoryImport, NamespaceHistoryLimits, NamespaceHistoryObjectRequest,
    NamespaceHistoryPage, NamespaceHistoryPageRequest, NamespaceHistoryReceiveCompletion,
