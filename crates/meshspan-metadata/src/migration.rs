...
pub(crate) const PARTITION_SCHEMA_VERSION: u32 = 120;
pub(crate) const LOCAL_SCHEMA_VERSION: u32 = 17;

const PARTITION_MIGRATIONS: [Migration; 120] = [
    Migration {
        version: 1,
    ...
    Migration {
        version: 47,
        sql: include_str!("../schema/partition/047_authentication_session_delivery.sql"),
    },
    Migration {
        version: 48,
        sql: include_str!("../schema/partition/048_totp_session_replay_steps.sql"),
    },
    Migration {
        version: 49,
        sql: include_str!("../schema/partition/049_authentication_session_rotation.sql"),
    },
    Migration {
        version: 50,
        sql: include_str!("../schema/partition/050_principal_administration_paging.sql"),
    },
    Migration {
        version: 51,
        sql: include_str!("../schema/partition/051_storage_targets.sql"),
    },
    Migration {
        version: 52,
        sql: include_str!("../schema/partition/052_node_wrapping_keys.sql"),
    },
    Migration {
        version: 53,
    ...
    Migration {
        version: 58,
        sql: include_str!("../schema/partition/058_fault_group_administration.sql"),
    },
    Migration {
        version: 59,
    ...
    Migration {
        version: 67,
        sql: include_str!("../schema/partition/067_storage_target_drains.sql"),
    },
    Migration {
        version: 68,
        sql: include_str!("../schema/partition/068_storage_target_drain_attestations.sql"),
    },
    Migration {
        version: 69,
    ...
    Migration {
        version: 72,
        sql: include_str!("../schema/partition/072_acme_orders.sql"),
    },
    Migration {
        version: 73,
        sql: include_str!("../schema/partition/073_public_certificate_installations.sql"),
    },
    Migration {
        version: 74,
        sql: include_str!("../schema/partition/074_acme_order_checkpoints.sql"),
    },
    Migration {
        version: 75,
        sql: include_str!("../schema/partition/075_manual_dns_tasks.sql"),
    },
    Migration {
        version: 76,
        sql: include_str!("../schema/partition/076_acme_provisioning_intent.sql"),
    },
    Migration {
        version: 77,
        sql: include_str!("../schema/partition/077_external_public_certificates.sql"),
    },
    Migration {
        version: 78,
        sql: include_str!("../schema/partition/078_mesh_local_certificate_authority.sql"),
    },
    Migration {
        version: 79,
        sql: include_str!("../schema/partition/079_mesh_local_certificate_issuances.sql"),
    },
    Migration {
        version: 80,
    ...
    Migration {
        version: 83,
        sql: include_str!("../schema/partition/083_metadata_backup_run_claims.sql"),
    },
    Migration {
        version: 84,
    ...
    Migration {
        version: 90,
        sql: include_str!("../schema/partition/090_notification_settings_binding.sql"),
    },
    Migration {
        version: 91,
...
#[cfg(test)]
pub(crate) fn partition_authentication_session_delivery_migration_digest() -> [u8; 32] {
    migration_digest(PARTITION_MIGRATIONS[46].sql)
}

#[cfg(test)]
pub(crate) fn partition_totp_session_replay_steps_migration_digest() -> [u8; 32] {
    migration_digest(PARTITION_MIGRATIONS[47].sql)
}

#[cfg(test)]
pub(crate) fn partition_authentication_session_rotation_migration_digest() -> [u8; 32] {
    migration_digest(PARTITION_MIGRATIONS[48].sql)
}

#[cfg(test)]
pub(crate) fn partition_storage_targets_migration_digest() -> [u8; 32] {
    migration_digest(PARTITION_MIGRATIONS[50].sql)
}

#[cfg(test)]
pub(crate) fn partition_node_wrapping_keys_migration_digest() -> [u8; 32] {
    migration_digest(PARTITION_MIGRATIONS[51].sql)
}

#[cfg(test)]
pub(crate) fn partition_secret_generations_migration_digest() -> [u8; 32] {
    migration_digest(PARTITION_MIGRATIONS[52].sql)
}
...
#[cfg(test)]
pub(crate) fn partition_builtin_fault_classes_migration_digest() -> [u8; 32] {
    migration_digest(PARTITION_MIGRATIONS[61].sql)
}
...
#[cfg(test)]
pub(crate) fn partition_metadata_backup_claim_migration_digest() -> [u8; 32] {
    migration_digest(PARTITION_MIGRATIONS[82].sql)
}

#[cfg(test)]
pub(crate) fn partition_backup_reclamation_migration_digest() -> [u8; 32] {
    migration_digest(PARTITION_MIGRATIONS[83].sql)
}

#[cfg(test)]
pub(crate) fn partition_backup_defaults_migration_digest() -> [u8; 32] {
    migration_digest(PARTITION_MIGRATIONS[84].sql)
}
...
#[cfg(test)]
pub(crate) fn local_totp_registration_ceremony_migration_digest() -> [u8; 32] {
    migration_digest(LOCAL_MIGRATIONS[9].sql)
}
