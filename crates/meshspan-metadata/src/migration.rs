...
pub(crate) const PARTITION_SCHEMA_VERSION: u32 = 50;
pub(crate) const LOCAL_SCHEMA_VERSION: u32 = 10;

const PARTITION_MIGRATIONS: [Migration; 50] = [
    Migration {
        version: 1,
...
const LOCAL_MIGRATIONS: [Migration; 10] = [
    Migration {
        version: 1,
