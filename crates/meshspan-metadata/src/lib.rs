...
pub use repository::{
    ...
    AuthenticationRegistrationProfile, AuthenticationService, AuthoritativeMembership,
    ...
    PrincipalKind, PrincipalRecord, RepositoryConformanceCheck, RepositoryConformanceReport,
