...
pub use repository::{
    ...
    AuthenticationPolicy, AuthenticationService, AuthoritativeMembership,
    AuthoritativeMetadataKernel, AuthoritativeRepository, BrowserSessionAccessRequest,
    BrowserSessionProtection, CommandReceipt, ConsensusStoreError, ConvergedVolumeHead, EntityKind,
    ...
    PartitionSnapshotManifest, PasskeySessionReplay, PasskeyVerificationMaterial,
    ...
    SnapshotScheduleCursor, SubjectGrantCursor, VersionCleanupAttestationProgress,
