...
pub use repository::{
    ...
    CertificateRenewalCandidate, CommandReceipt, ConsensusStoreError, ConvergedVolumeHead,
    DueCertificateOrderCursor, DueCertificateRenewalCursor, DueStorageScrub, DueStorageScrubCursor,
    DueStorageScrubPage, EncryptedBackupPaths, EncryptedPartitionBackupManifest,
    EncryptedRestorePaths, EntityKind, EntityReference, ExternalCertificateInstallationRecord,
