...
pub use repository::{
    ...
    SessionRevocationReplay, SmbVerificationMaterial, SnapshotCursor, SnapshotExpiryCandidate,
    SnapshotExpiryCursor, SnapshotSchedule, SnapshotScheduleCursor, StorageTargetProviderContext,
