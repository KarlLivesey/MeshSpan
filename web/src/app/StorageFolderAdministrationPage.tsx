...
import { StorageFolderAdministrationPanel } from "../features/storage-folder-administration/StorageFolderAdministrationPanel";
import { useSession } from "./session";

export function StorageFolderAdministrationPage(): JSX.Element {
    ...
    <Switch>
      ...
      <Match when={session.state().phase === "anonymous"}>
        <section class="route-status">
          ...
          <p>Sign in before changing local storage.</p>
