...
import { CertificateAdministrationPanel } from "../features/certificate-administration/CertificateAdministrationPanel";
import { useSession } from "./session";

export function CertificateAdministrationPage(): JSX.Element {
    ...
    <Switch>
      ...
      <Match when={session.state().phase === "anonymous"}>
        <section class="route-status">
          ...
          <p>Sign in before changing public certificate settings.</p>
