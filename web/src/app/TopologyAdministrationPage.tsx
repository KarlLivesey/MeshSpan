...
import { TopologyAdministrationPanel } from "../features/topology-administration/TopologyAdministrationPanel";
import { useSession } from "./session";

export function TopologyAdministrationPage(): JSX.Element {
    ...
    <Switch>
      ...
      <Match when={session.state().phase === "anonymous"}>
        <section class="route-status">
          ...
          <p>Sign in before changing mesh topology.</p>
