...
import { BackupAdministrationPanel } from "../features/backup-administration/BackupAdministrationPanel";
import { useSession } from "./session";

export function BackupAdministrationPage(): JSX.Element {
    ...
    <Switch>
      ...
      <Match when={session.state().phase === "anonymous"}>
        <section class="route-status">
          ...
          <p>Sign in before changing metadata backup settings.</p>
      ...
      <Match when={true}>
        <section class="route-status">
          ...
          <p>
            System-manager authority and a current mutation proof are required.
          </p>
        </section>
      </Match>
    </Switch>
