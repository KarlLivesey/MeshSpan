 ...
 */
export type ConfigureNotificationRequest = {
  /**
 ...
 */
export type ConfigureNotificationResponse = {
  /**
 ...
 */
export type MetadataDiagnosticsResponse = {
  /**
   * Local system-clock time at collection start, not a mesh-time uncertainty proof.
   */
  collected_at_epoch_micros: number;
...
export type NotificationsResponse = {
   ...
   */
  worker: "running" | "retrying" | "stopped";
};
...
export type ReadMetadataDiagnosticsData = {
  ...
  path?: never;
  query?: never;
  url: "/admin/diagnostics/metadata";
};

export type ReadMetadataDiagnosticsErrors = {
  /**
   * Unsupported query or body
   */
  400: ApiError;
...
export type ReadMetadataDiagnosticsError =
  ReadMetadataDiagnosticsErrors[keyof ReadMetadataDiagnosticsErrors];

export type ReadMetadataDiagnosticsResponses = {
  /**
   * Redacted local metadata observations
   */
  200: MetadataDiagnosticsResponse;
};
...
export type ConfigureNotificationData = {
  /**
   * Complete configuration and explicit destination update
   */
  body: ConfigureNotificationRequest;
  headers?: {
    /**
     * Required for browser-cookie authentication and omitted for API-key authentication.
     */
...
export type ConfigureNotificationErrors = {
  /**
...
export type ConfigureNotificationError =
  ConfigureNotificationErrors[keyof ConfigureNotificationErrors];

export type ConfigureNotificationResponses = {
  /**
   * Original committed configuration receipt
   */
  200: ConfigureNotificationResponse;
};

export type ConfigureNotificationResponse2 =
  ConfigureNotificationResponses[keyof ConfigureNotificationResponses];
