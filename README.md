...
before version 1.0. The design contract and Stages 1–3 are complete; folder storage and safe shard
lifecycle are the active implementation stage. The accepted requirements, architecture,
