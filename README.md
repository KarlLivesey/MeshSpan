...
before version 1.0. The executable foundations through Stage 8 and the accepted authentication,
...
administration, operation tracking, create/join first-start paths, fault-aware placement,
streaming erasure coding and degraded reads. See the
[Stage 8 evidence](design/stage-8-evidence.md), [Stage 7 evidence](design/stage-7-evidence.md),
